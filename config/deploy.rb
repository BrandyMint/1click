...
set :linked_dirs, %w(log tmp/pids tmp/cache tmp/sockets vendor/bundle public/system public/assets public/uploads public/.well-known)
...
#    run_locally do
#      execute :rake, 'bugsnag:deploy BUGSNAG_API_KEY=', '--trace' # Bugsnag rails
#      execute :rake, 'bugsnag:deploy BUGSNAG_API_KEY=', '--trace' # Bugsnag JS
#    end
#  end
