...
class EventCreatorTest < ActiveSupport::TestCase
  ...
  PARAMS_TYPE_1 = {"a"=>"333", "d"=>"rawgit.com", "g"=>"Test Title", "m"=>"web", "p"=>"/BrandyMint/aristotel/master/example/test.html", "s"=>"2564470158", "t"=>"1", "u"=>"8992569949901988", "v"=>"0435525828", "tm"=>"1448003913978", "r"=>"http://rawgit.com/BrandyMint/aristotel/master/example/test.html"}

  PARAMS_TYPE_2 = {"a"=>"333", "d"=>"rawgit.com", "g"=>"Test Title", "m"=>"web", "p"=>"/BrandyMint/aristotel/master/example/test.html", "s"=>"2564470158", "t"=>"2", "u"=>"8992569949901988", "v"=>"1906698993", "tm"=>"1448004295028"}

  PARAMS_CLICK = {"a"=>"333", "m"=>"web", "s"=>"2564470158", "u"=>"8992569949901988", "v"=>"1906698993", "f0"=>"http://3009.vkontraste.ru/", "n0"=>"a", "t0"=>"click", "tm"=>"1448004407914", "w0"=>"@a;|", "x0"=>"3009.vkontraste.ru"}
